...
export const ClozePassageQuestion: React.FC<Props> = ({
  ...
  const renderPassageWithBlanks = () => {
    ...
    return (
      <div className="text-sm sm:text-base leading-[2.1] text-theme-primary font-normal space-y-2 reader-body">
  ...
  return (
    <div ref={containerRef} className="w-full space-y-4 pt-1">
      {/* Passage Reader Card */}
      <div className="p-5 sm:p-7 rounded-3xl surface-subtle shadow-2xs transition-all">
      ...
      {isFinished && question.explanation && (
        <div className="p-4 sm:p-5 rounded-2xl surface-card text-xs sm:text-sm text-theme-primary leading-relaxed animate-in fade-in duration-200 reader-explanation">
          <p className="font-black text-theme-accent mb-1">✓ Passage Summary & Explanation:</p>
