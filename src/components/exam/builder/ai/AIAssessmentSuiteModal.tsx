            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all ${
                  activeTab === tab.id
                    ? 'bg-indigo-50 text-indigo-950 border border-indigo-200 font-black shadow-2xs'
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-xs flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white text-xs font-bold flex items-center gap-1.5 transition-all shrink-0 shadow-xs"
                >
                  {isRunningCheck ? (
                    <>
              ...
              {checkResults ? (
                ...
                <div className="p-8 text-center bg-white rounded-2xl border border-dashed border-slate-300 text-slate-600 font-medium text-xs">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              ...
              <div className="space-y-2 pt-2">
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-between text-xs">
                  <span className="font-bold text-slate-900">Vocabulary Competencies</span>
                  <span className="font-black text-emerald-700">95% Aligned</span>
                </div>
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-between text-xs">
                  <span className="font-bold text-slate-900">Grammar & Syntax Application</span>
                  <span className="font-black text-emerald-700">90% Aligned</span>
                </div>
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-between text-xs">
                  <span className="font-bold text-slate-900">Reading Comprehension Skills</span>
                  <span className="font-black text-emerald-700">100% Aligned</span>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <div className="p-3.5 rounded-xl bg-white border border-slate-300 shadow-2xs">
                  <span className="text-xs font-black text-slate-950 block">Content (4 Marks)</span>
                  <span className="text-[11px] text-slate-700 font-medium mt-1 block leading-relaxed">Relevance to prompt, development of ideas, clarity.</span>
                </div>
                <div className="p-3.5 rounded-xl bg-white border border-slate-300 shadow-2xs">
                  <span className="text-xs font-black text-slate-950 block">Vocabulary (2 Marks)</span>
                  <span className="text-[11px] text-slate-700 font-medium mt-1 block leading-relaxed">Appropriate word choice, spelling accuracy.</span>
                </div>
                <div className="p-3.5 rounded-xl bg-white border border-slate-300 shadow-2xs">
                  <span className="text-xs font-black text-slate-950 block">Grammar (2 Marks)</span>
                  <span className="text-[11px] text-slate-700 font-medium mt-1 block leading-relaxed">Sentence structure, tense consistency, punctuation.</span>
                </div>
                <div className="p-3.5 rounded-xl bg-white border border-slate-300 shadow-2xs">
                  <span className="text-xs font-black text-slate-950 block">Organization (2 Marks)</span>
                  <span className="text-[11px] text-slate-700 font-medium mt-1 block leading-relaxed">Cohesion, logical flow, paragraphing.</span>
                </div>
              </div>
            </div>
          )}
