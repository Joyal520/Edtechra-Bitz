...
export const AdminShortsSection: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 3 & 4. Shorts Directory Catalogue (Collapsible by default) */}
      <CollapsibleCatalogue
        title="YouTube Shorts Catalogue"
        count={shorts.length}
        icon={<Film className="w-4 h-4 text-red-600" />}
        subtitle="Search, filter, manage, and attach quiz bits to video shorts."
      >
        {/* Search & Filter Bar */}
        <div className="bg-slate-50/70 border border-stone-200/80 rounded-2xl p-3 sm:p-4 flex flex-wrap items-center justify-between gap-3">
