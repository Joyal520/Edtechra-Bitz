                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {!isTeacher && isCompleted && (
                          <span className="text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-800 border border-emerald-200 flex items-center gap-1">
                            ...
                            {mySub?.percentage != null ? `${mySub.percentage}% Graded` : 'Graded'}
                          </span>
                        )}
                        {!isTeacher && isEvaluating && (
                          <span className="text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded-full bg-indigo-100 text-indigo-800 border border-indigo-200 flex items-center gap-1">
