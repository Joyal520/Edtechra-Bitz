...
-- REFINE UNIFIED LEARNING EVENTS TOPICS
-- ============================================================================
...
SELECT
    ...
    COALESCE(NULLIF(a.subtitle, ''), NULLIF(a.title, ''), a.category, 'Task')::text AS topic,
...
SELECT
    ...
    COALESCE(NULLIF(e.title, ''), c.subject, 'Exam')::text AS topic,
...
SELECT
    ...
    COALESCE(NULLIF(lq.title, ''), lq.category, 'Live Quiz')::text AS topic,
...
SELECT
    ...
    COALESCE(NULLIF(ocr.title, ''), ocr.category, 'Worksheet Assessment')::text AS topic,
...
SELECT
    ...
    COALESCE(NULLIF(ac.title, ''), ac.category, 'Writing Challenge')::text AS topic,
